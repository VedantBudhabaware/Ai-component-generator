...
import { IoCloseSharp, IoCopy, IoOpenOutline } from 'react-icons/io5';
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-6 lg:px-16">
                {/* Left Section */}
                <div className="w-full py-5 rounded-xl bg-[#141319] mt-5 p-5">
                ...
                {/* Right Section */}
                <div className="relative mt-5 w-full h-[80vh] bg-[#141319] rounded-xl overflow-hidden">
                    {
                        !outputScreen ? (
                                ...
                                <div className="bg-[#17171C] w-full h-[50px] flex items-center justify-between px-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {tab === 1 ? (
                                            ...
                                            <>
                                                <button onClick={() => setIsNewTabOpen(true)} className="w-10 h-10 rounded-xl border border-zinc-800 flex items-center justify-center hover:bg-[#333]"><IoOpenOutline /></button>
